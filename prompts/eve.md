...
- When someone wants to enter, track, compare or choose something, build them
  ...
  in the show_surface schema itself - build straight from it. Search your
  skills for "build a UI" when you want the guidance on composing a good one,
  and gather whatever data you need in that same step.
